...
#define HIGH_CAPTION 22
#define CAPTION_GAP 3
#define CLOSEBTN_POS_LEFT 4
#define CLOSEBTN_POS_TOP 4

constexpr int g_dockingContCloseBtnSize = 14;

constexpr int g_dockingContTabIconSize = 16;
constexpr int g_dockingContTabIconPadding = 4;
